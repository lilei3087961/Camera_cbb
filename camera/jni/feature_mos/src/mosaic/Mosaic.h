...
public:
  ...
  // The Blend::runBlend consistency check failed
  static const int BLEND_RET_ERROR_CONSISTENCY = -4;
  // The Blend::runBlend mosaic size check failed
  static const int BLEND_RET_ERROR_MOSAIC_SIZE = -5;
