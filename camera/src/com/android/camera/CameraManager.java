...
public class CameraManager {
    ...
    private static final int SET_HISTOGRAM_MODE = 23;
    private static final int SEND_HISTOGRAM_DATA = 24;
    private static final int ONE_SHOT_PREVIEW_CALLBACK = 25;
    private static final int START_PREVIEW_SYNC = 26;
    private static final int SET_PREVIEW_TEXTURE_SYNC = 27;
            ...
            try {
                switch (msg.what) {
                    ...
                    case SEND_HISTOGRAM_DATA:
                        ...
                        break;
                    case ONE_SHOT_PREVIEW_CALLBACK:
    ...
    public class CameraProxy {
        ...
        public void setPreviewTextureSync(final SurfaceTexture surfaceTexture) {
        	mSig.close();
            mCameraHandler.obtainMessage(SET_PREVIEW_TEXTURE_SYNC, surfaceTexture).sendToTarget();
            mSig.block();
        }
        ...
        public void startPreviewsSync() {
        	mSig.close();
            mCameraHandler.sendEmptyMessage(START_PREVIEW_SYNC);
            mSig.block();
        }
        ...
        public void setOneShotPreviewCallback(PreviewCallback cb) {
            mSig.close();
            mCameraHandler.obtainMessage(ONE_SHOT_PREVIEW_CALLBACK, cb).sendToTarget();
            mSig.block();
        }
    }
}
