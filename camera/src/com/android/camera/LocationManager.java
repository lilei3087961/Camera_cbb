...
public class LocationManager {
    ...
    public static boolean hasGpsSignal = false;
    ...
    private void startReceivingLocationUpdates() {
        ...
        if (mLocationManager != null) {
            ...
            try {
                ...
                if (mListener != null) {
                	hasGpsSignal = (getCurrentLocation() == null) ? false:true;
                    mListener.showGpsOnScreenIndicator(hasGpsSignal);
                }
            } catch (SecurityException ex) {
                Log.i(TAG, "fail to request location update, ignore", ex);
            } catch (IllegalArgumentException ex) {
    ...
    private class LocationListener
        ...
        public void onLocationChanged(Location newLocation) {
            ...
            if (mListener != null &&
            		...
            		android.location.LocationManager.NETWORK_PROVIDER.equals(mProvider)) {
        ...
        public void onStatusChanged(
            ...
            switch(status) {
                ...
                case LocationProvider.AVAILABLE:
                	mValid = true;
                	hasGpsSignal = true;
                	if (mListener != null) mListener.showGpsOnScreenIndicator(true);
                	break;
            }
        }
