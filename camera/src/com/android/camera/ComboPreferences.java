...
public class ComboPreferences implements SharedPreferences, OnSharedPreferenceChangeListener {
    ...
    private static boolean isGlobal(String key) {
        return key.equals(CameraSettings.KEY_VIDEO_TIME_LAPSE_FRAME_INTERVAL)
                ...
                || key.equals(CameraSettings.KEY_VIDEO_RECORD_LOCATION)
                ...
                || key.equals(CameraSettings.KEY_SILENT_MODE) //Add by wangbin at 2013-03-22
                //BEGIN: Added by xiongzhu at 2013-04-16
                || key.equals(CameraSettings.KEY_CAMERA_STORAGE_PLACE)
                //END:   Added by xiongzhu at 2013-04-16
