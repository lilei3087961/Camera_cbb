...
public class EffectsRecorder {
    ...
    private boolean mIsMediaRecorderStopException = false;
    ...
    */
    ...
    private synchronized void initializeEffect(boolean forceReset) {
        if (forceReset ||
            ...
            mIsMediaRecorderStopException = false;
    ...
    private SurfaceTextureSourceListener mSourceReadyCallback =
        ...
        public void onSurfaceTextureSourceReady(SurfaceTexture source) {
            ...
            synchronized(EffectsRecorder.this) {
                ...
                if (mCameraDevice == null) {
                    Log.w(TAG, "Effects already disconnected from Camera.");
                    return;
                }
                mCameraDevice.stopPreview();
    ...
    public synchronized void stopPreview() {
        ...
        mOldRunner = mRunner;
        if (mIsMediaRecorderStopException) {
        ...
        public void onRunnerDone(int result) {
            synchronized(EffectsRecorder.this) {
                ...
                if (result == GraphRunner.RESULT_ERROR) {
                    ...
                    if (e instanceof MediaRecorderStopException) {
                        mIsMediaRecorderStopException = true;
                    }
                    raiseError(e);
                }
                if (mOldRunner != null) {
