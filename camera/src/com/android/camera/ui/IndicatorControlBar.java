...
public class IndicatorControlBar extends IndicatorControl implements
    ...
    public void initialize(Context context, PreferenceGroup group,
        ...
        /**initializeCameraPicker(); delete by xiongzhu for cbb
    ...
    protected void onLayout(
        ...
        if (getResources().getConfiguration().orientation
            ...
            /**if (mCameraPicker != null) { delete by xiongzhu for cbb
            ...
            if (mZoomControl != null) {
                ...
                //        height - padding - size);
                mZoomControl.layout(0, 60, width ,height -60 );
            }
            ...
            //}
            if (mZoomControl != null)  {
                mZoomControl.layout(60, 0, width -60, height);
            }
