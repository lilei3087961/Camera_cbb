...
public class RotateTextToast {
    public static final int TOAST_DURATION = 5000; // milliseconds
     ...
     * @param orientation The new orientation for the Toast.
     */
    public void setText(int resId, int orientation) {
        if (!flag) return;
        if (mToast != null) {
            mToast.setOrientation(orientation, false);
            TextView tv = (TextView) mToast.findViewById(R.id.message);
