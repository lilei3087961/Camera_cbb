...
public class RotateLayout extends ViewGroup implements Rotatable {
    ...
    private OnLayoutFinishNotify mLayoutFinishNotify;
    
    public static interface OnLayoutFinishNotify {
        public void onLayoutFinishNotify(int orientation);
    }

    public void setmLayoutFinishNotify(OnLayoutFinishNotify layoutFinishNotify) {
    	mLayoutFinishNotify = layoutFinishNotify;
    }
    ...
    protected void onLayout(
        ...
        if(mLayoutFinishNotify != null) {
        	mLayoutFinishNotify.onLayoutFinishNotify(mOrientation);
        	mLayoutFinishNotify = null;
        }
    }
