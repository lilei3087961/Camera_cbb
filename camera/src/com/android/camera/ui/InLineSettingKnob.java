...
//                    mNext = true;
//                    //set mPrevious as false since we only want to change to next.
//                    mPrevious = false;
...
//                    mPrevious = true;
//                    //set mNext as false since we only want to change to previous
//                    mNext = false;
//                    // Give bigger delay so users can change only one step.
////                    mHandler.postDelayed(mRunnable, 300);
//                }
...
//                mNextButton.setVisibility(index == 0 ? View.INVISIBLE : View.VISIBLE);
//                mPrevButton.setVisibility(index == mPreference.getEntryValues().length - 1
//                		? View.INVISIBLE : View.VISIBLE);
            } else {
