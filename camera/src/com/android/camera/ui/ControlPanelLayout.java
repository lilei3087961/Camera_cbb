...
public class ControlPanelLayout extends RelativeLayout {
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        //BEGIN: Modified by zhanghongxing at 2013-01-08 for full preview
        ...
        // }
        if (isLandscape) {
            measuredSize = widthSpecSize;
        } else {
            measuredSize = heightSpecSize;
        }
        //END:   Modified by zhanghongxing at 2013-01-08
