    ...
    public void setDisplayOptions(boolean displayHomeAsUp, boolean showTitle) {
        if (mActionBar != null) {
            ...
            mActionBar.setDisplayOptions(options,
                    ActionBar.DISPLAY_HOME_AS_UP | ActionBar.DISPLAY_SHOW_TITLE | ActionBar.DISPLAY_USE_LOGO);
            mActionBar.setIcon(R.mipmap.ic_launcher_gallery);
            mActionBar.setHomeButtonEnabled(displayHomeAsUp);
        }
    }
    public void setHomeButton(boolean displayHomeAsUp) {
        mActionBar.setHomeButtonEnabled(displayHomeAsUp);
    }
