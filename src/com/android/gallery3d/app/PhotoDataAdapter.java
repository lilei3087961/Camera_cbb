...
public class PhotoDataAdapter implements PhotoPage.Model {
    ...
    public int getIndexbyPath(Path path) {
        ...
        for (int index = mContentStart; index < mContentEnd; ++index) {
            MediaItem item = mData[index % DATA_CACHE_SIZE];
    ...
    private class UpdateContent implements Callable<Void> {
        ...
        public Void call() throws Exception {
            ...
            // Update mItempath
            MediaItem current = mData[mCurrentIndex % DATA_CACHE_SIZE];
            mItemPath = current == null ? mItemPath : current.getPath();
            ...
            while (mActive) {
                ...
                synchronized (DataManager.LOCK) {
                    ...
                    if (mFocusHintPath != null) {
                        ...
                        // Found in Cache, Update mItemPath by mFocusHintPath
                        if(index != MediaSet.INDEX_NOT_FOUND)
                        {
                            mItemPath = mFocusHintPath;
                        }
                        mFocusHintPath = null;
                    }
