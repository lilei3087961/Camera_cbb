...
public class SinglePhotoDataAdapter extends TileImageViewAdapter
    ...
    private Context mContext; // Context definition
    ...
    public SinglePhotoDataAdapter(
        ...
        mContext = activity.getAndroidContext(); // get GalleryActivity context
        ...
        public void onFutureDone(Future<BitmapRegionDecoder> future) {
            ...
            if (decoder == null) {
                if (mTask != null && !mTask.isCancelled()) {
                    Log.v(TAG, "fail to get decoder, try to request thumb image");
                    mHasFullImage = false;
                    pause();
                    resume();
                }
    ...
    private void onDecodeThumbComplete(Future<Bitmap> future) {
        try {
            ...
            if (backup == null) {
                ...
                // when decode is null prompt information.
                Toast.makeText(mContext, R.string.fail_to_load_image,
