...
final class Config {
    ...
    public static class AlbumPage {
        ...
        public SlotView.Spec slotViewSpec;
        public AlbumSetBarView.Spec albumSetBarSpce;
        public LabelSpec labelSpec;
        ...
        private AlbumPage(Context context) {
            ...
            */
            ...
            albumSetBarSpce = new AlbumSetBarView.Spec();
            albumSetBarSpce.slotWidth = r.getDimensionPixelSize(R.dimen.set_bar_slot_width);
            albumSetBarSpce.slotHeight = r.getDimensionPixelSize(R.dimen.set_bar_slot_height);
            albumSetBarSpce.slotGap = r.getDimensionPixelSize(R.dimen.set_bar_album_slot_gap);
            albumSetBarSpce.arrowWidth = r.getDimensionPixelSize(R.dimen.albumsetbar_arrow_width);
            albumSetBarSpce.arrowHeight = r.getDimensionPixelSize(R.dimen.albumsetbar_arrow_height);
            
            labelSpec = new LabelSpec();
            labelSpec.labelBackgroundHeight = r.getDimensionPixelSize(
                    R.dimen.albumsetbar_label_background_height);
            labelSpec.titleOffset = r.getDimensionPixelSize(
                    R.dimen.albumsetbar_title_offset);
            labelSpec.countOffset = r.getDimensionPixelSize(
                    R.dimen.albumsetbar_count_offset);
            labelSpec.titleFontSize = r.getDimensionPixelSize(
                    R.dimen.albumsetbar_title_font_size);
            labelSpec.countFontSize = r.getDimensionPixelSize(
                    R.dimen.albumsetbar_count_font_size);
            labelSpec.leftMargin = r.getDimensionPixelSize(
                    R.dimen.albumsetbar_left_margin);
            labelSpec.iconSize = r.getDimensionPixelSize(
                    R.dimen.albumsetbar_icon_size);
        }
    }
