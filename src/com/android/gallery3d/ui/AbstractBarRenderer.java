...
public abstract class AbstractBarRenderer implements AlbumSetBarView.SlotRenderer {
    ...
    private final NinePatchTexture mBarItemFrame;

    protected AbstractBarRenderer(Context context) {
        ...
        mArrow = new ResourceTexture(context, R.drawable.arrow);
        mBarItemFrame = new NinePatchTexture(context, R.drawable.grid_frame);
    }
    ...
    protected void drawArrow(GLCanvas canvas, int width, int height) {
        mArrow.draw(canvas, 0, 0, width, height);
    }
    ...
    protected void drawBarItemFrame(GLCanvas canvas, int width, int height) {
        drawFrame(canvas, mBarItemFrame.getPaddings(), mBarItemFrame, 0, 0, width, height);
    }
