    ...
    private class HighlightRectangle extends GLView {
        ...
        private void drawHighlightRectangle(GLCanvas canvas, RectF r) {
            ...
            if (mSpotlightRatioX == 0 || mSpotlightRatioY == 0) {
                ...
                // Filling transparent into the crop area to highlight it.
                canvas.fillRect(r.left, r.top, r.width(), r.height(), Color.TRANSPARENT);
            }
            ...
            // Dimming around the crop area not including the crop area.
            canvas.fillRect(0, 0, getWidth(), r.top, 0xA0000000);
            canvas.fillRect(0, r.top, r.left, getHeight(), 0xA0000000);
            canvas.fillRect(r.right, r.top, getWidth() - r.right, getHeight() - r.top, 0xA0000000);
            canvas.fillRect(r.left, r.bottom, r.width(), getHeight() - r.bottom, 0xA0000000);
