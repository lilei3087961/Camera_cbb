...
public class AlbumSetBarRenderer extends AbstractBarRenderer {
    ...
    private AlbumSetBarView mSlotView;
    ...
    public AlbumSetBarRenderer(GalleryActivity activity, SelectionManager selectionManager,
            AlbumSetBarView slotView, LabelSpec labelSpec) {
    ...
    public int renderSlot(GLCanvas canvas, int index, int pass, int width, int height) {
        ...
        int contentHeight = width;
        
        renderRequestFlags |= renderContent(canvas, entry, contentWidth, contentHeight);
        renderRequestFlags |= renderLabel(canvas, entry, width, height);
        renderRequestFlags |= renderOverlay(canvas, index, entry, contentWidth, contentHeight);
    ...
    protected int renderOverlay(
        ...
        if (mPressedIndex == index) {
            if (mAnimatePressedUp) {
                ...
                renderRequestFlags |= AlbumSetBarView.RENDER_MORE_FRAME;
            ...
            drawBarItemFrame(canvas, width, height);
        }
    ...
    protected int renderLabel(
            GLCanvas canvas, AlbumSetEntry entry, int width, int height) {
        Texture content = checkTexture(entry.barLabelTexture);
        if (content != null) {
