...
public class GLRootView extends GLSurfaceView
    ...
    private void layoutContentPane() {
        ...
        if (mOrientationSource != null) {
            ...
            compensation = mAnimationRunning ? mCompensation : mOrientationSource.getCompensation();
        } else {
            displayRotation = 0;
            compensation = 0;
        }
    ...
    private class IdleRunner implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                /*
                 * libEGL error: call to OpenGL ES API with no current context.
                 * then java.lang.UnsupportedOperationException is out.
                 * */
                e.printStackTrace();
                Log.e(TAG, "in GLThread, it happen. we abandon the exception.");
            } finally {
                mRenderLock.unlock();
            }
            synchronized (mIdleListeners) {
    ...
    @Override
    public void onPause() {
        // We put a black cover View in front of the SurfaceView after
        // pause, and hide it after the first draw. It prevents the
        // SurfaceView being transparent before the first draw.
        if(!mFirstDraw) {
            View root = getRootView();
            View cover = root.findViewById(R.id.gl_root_cover);
