...
class UriSource extends MediaSource {
    ...
    public Path findPathByUri(Uri uri, String type) {
        ...
        // Try to find a most specific type started with "image/"
        if ((null == type) || isImageType(type, mimeType)) {
            type = mimeType;
        }
    ...
    private boolean isImageType(String type, String mimeType) {
        return ((IMAGE_TYPE_ANY.equals(type)
