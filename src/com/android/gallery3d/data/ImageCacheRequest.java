...
abstract class ImageCacheRequest implements Job<Bitmap> {
    ...
    public Bitmap run(JobContext jc) {
        ...
        ImageCacheService cacheService = null;
        // when sd card is not mounted currently, not to get cache service.
        if (OurEnvironment.getExternalCacheDir() != null) {
            cacheService = mApplication.getImageCacheService();
        }
        ...
        try {
            ...
            if (cacheService != null) {
                found = cacheService.getImageData(mPath, mType, buffer);
            }
