...
class LocalSource extends MediaSource {
    ...
    @Override
    public void pause() {
    // Monkey may kill or disable the MediaStorage Application by Setting.
    // On this situation mClient is null, so we will add protection to avoid
    // Gallery force close issue.
        if (mClient != null) {
            mClient.release();
            mClient = null;
        }
