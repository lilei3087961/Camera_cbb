...
public class WidgetConfigure extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (mWidgetType == 0) {
            ...
            List<WidgetDatabaseHelper.Entry> entrys = helper.getEntries(WidgetDatabaseHelper.TYPE_ALBUM);
            /*if (entrys.size() > 0) {
                String widgetTitle = this.getString(R.string.appwidget2_title);
                String msg = this.getString(R.string.appwidget2_onlyone, widgetTitle);
