...
public class HlistWidgetService extends RemoteViewsService {

    @SuppressWarnings("unused")
    private static final String TAG = "HlistWidgetService";
    ...
    private static class PhotoRVFactory implements
        ...
        public RemoteViews getLoadingView() {
            RemoteViews rv = new RemoteViews(
                    ...
                    R.layout.appwidget2_hlistview_loading_item);
            rv.setProgressBar(R.id.appwidget2_hlistview_loading_item, 0, 0, true);
            return rv;
        }
        ...
        public RemoteViews getViewAt(int position) {
            ...
            if (mSource != null) {
                try {
                    bitmap = mSource.getHlistImage(position);
            ...
            RemoteViews views = new RemoteViews(
                    mApp.getAndroidContext().getPackageName(),
                    R.layout.appwidget2_photo_item);
            views.setImageViewBitmap(R.id.appwidget2_photo_item, bitmap);
            /*
            if (mSource != null) {
                views.setOnClickFillInIntent(R.id.appwidget2_photo_item, new Intent()
