...
public class PhotoEditor extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            //get the persisted state of save icon
            boolean saveState = savedInstanceState.getBoolean(SAVE_STATE_KEY);
            if (saveUri == null && !saveState) {
                actionBar.updateSave(false);
            } else {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean(SAVE_STATE_KEY, actionBar.canSave());
    }
